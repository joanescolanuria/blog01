    ...
    <div className='py-5 px-5 md:px-12 lg-px-28'>
        ...
        <div className='text-center my-8'>
          ...
          <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>
            ¡Bienvenido a mi blogs directo AAAAA! Este espacio está dedicado a proyectos y tutoriales sobre desarrollo backend, siempre con ejemplos prácticos y consejos útiles. Si te apasiona la programación, ¡este es el lugar perfecto para ti!
          </p>
